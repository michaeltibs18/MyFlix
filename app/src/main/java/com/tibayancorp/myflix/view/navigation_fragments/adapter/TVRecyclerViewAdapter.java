...
import com.tibayancorp.myflix.view.navigation_fragments.TVFragment.OnListFragmentInteractionListener;
...
public class TVRecyclerViewAdapter extends RecyclerView.Adapter<TVRecyclerViewAdapter.ViewHolder> {
    ...
    public TVRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
